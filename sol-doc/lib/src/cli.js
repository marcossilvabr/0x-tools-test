...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const docs = (0, transform_docs_1.transformDocs)(yield (0, extract_docs_1.extractDocsAsync)(sources, argv.root), {
    ...
    if (argv.md) {
        yield writeTextFileAsync(argv.md, (0, gen_md_1.generateMarkdownFromDocs)(docs, { urlPrefix: argv.mdUrlPrefix }));
    }
}))().catch(err => {
...
function getContractsAsync(contractsGlobs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const g of contractsGlobs) {
            sources = [...sources, ...(yield (0, util_1.promisify)(glob)(g))];
        }
        return sources;
    });
}
function writeTextFileAsync(file, content) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, util_1.promisify)(fs.writeFile)(file, content, { encoding: 'utf-8' });
    });
}
